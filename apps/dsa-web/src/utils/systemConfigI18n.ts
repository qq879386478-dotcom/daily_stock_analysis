...
const fieldTitleMap: Record<string, string> = {
  ...
  DSA_ALLOW_INSECURE_PUBLIC_API: '允许不安全公网 API',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  WEBUI_HOST: 'WebUI 服务监听地址（未配置时默认 127.0.0.1；公网监听需启用管理员认证）。',
  ADMIN_AUTH_ENABLED: '启用 Web 管理端账号密码登录校验。',
  DSA_ALLOW_INSECURE_PUBLIC_API: '仅用于可信内网或临时调试：允许公网监听且关闭管理员认证；公网部署应保持关闭并启用管理员认证。',
