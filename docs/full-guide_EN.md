...
> For this PR evidence, run/review `tests/test_config_env_compat.py`, `tests/test_system_config_service.py::test_runtime_env_fallback_does_not_persist_llm_fields_on_save`, `tests/test_system_config_service.py::test_runtime_env_fallback_does_not_override_saved_provider_and_base_url_settings`, `tests/test_system_config_service.py::test_import_desktop_env_preserves_hidden_web_settings_keys`, `tests/test_system_config_service.py::test_import_desktop_env_merges_keys_without_deleting_unspecified_values`, and `tests/test_system_config_service.py::test_update_alphasift_enable_does_not_rewrite_llm_fields`.
